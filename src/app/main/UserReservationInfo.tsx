...
const UserReservationInfo: React.FC<EventProps> = ({ event }) => {
  ...
  return (
    <>
      {/* 유저 예약 정보*/}
      <div className="flex flex-col gap-4 mx-4 p-5 rounded-xl">
            ...
            <div className="flex-1 mr-4">
              <div className="flex justify-center items-center w-full h-full">
                <svg
                  ...
                  viewBox="0 -4 24 32"
                  className="w-32 h-32 fill-black bg-white group-hover:fill-black hover:bg-yellow-300 transition-colors duration-200 rounded-xl"
                >
